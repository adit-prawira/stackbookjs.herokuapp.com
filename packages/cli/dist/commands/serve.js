    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    directory = path_1.default.join(process.cwd(), path_1.default.dirname(filename));
                    return [4 /*yield*/, local_api_1.serve(parseInt(options.port), path_1.default.basename(filename), directory)];
                case 1:
                    _a.sent();
                ...
                case 2:
                    ...
                    if (err_1.code === "EADDRINUSE") {
                        console.error("PORT is already in use. Try running in different port.");
                    }
                    else {
                        //@ts-ignore
